...
<html>
    ...
    <body>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Guardado!</strong> Guardado correctamente.
        ...
        <div class="contenedor ordenar-footer-all" >
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-success btn-lg" onclick="window.location.href='Portal.jsp'">Volver al Inicio</button>
                </div>
            </div>
        </div>
