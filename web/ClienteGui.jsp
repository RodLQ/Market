<%-- 
    Document   : ClienteGui
    Created on : 16-abr-2021, 13:42:32
    Author     : PC
--%>
...
<html>
    ...
    <body>
        ...
        <div class="ordenar-footer-cliente" >
            <div class="container">
                <br>
                <br>
                <br>
                    ...
                    <div class="col-10">
                        <div class="row">
                            <div class="col-12 col-xl-6 border rounded bordesombra" >
                                <form  class="p-4" action="ClienteControl" method="post">
                                    <h4 class="text-secondary" >Registrar Cliente</h4>
                                    <div class="m-3 text-secondary" >
                                        <div class="row"><h5>Código :</h5></div>
                                        <div class="row"><div class="col-12"><input class="btn-lg border-success col-12" type="text" name="codCli"></div></div>
                                        ...
                                        <div class="row"><h5>Dirección :</h5></div>
                                        <div class="row"><div class="col-12"><input class="btn-lg border-success col-12 " type="text" name="dir"></div></div>
                                        <div class="row">
                            ...
                            <div class="col-12 col-xl-6 border rounded borrarimagen bordesombra" >
                                <div class="row" >
                                    <img src="img/compra2.jpg" class="img-fluid rounded" >
                                </div>
                            </div>
                        </div>
                    </div>
