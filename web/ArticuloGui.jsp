<%-- 
    ...
    Created on : 20-may-2021, 17:55:26
    Author     : PC
--%>
        ...
        <div class="ordenar-footer-all container" >           
            ...
            <div class="row text-center">
                ...
                <div class="col-12 col-xl-6 border rounded p-5" >
                    <h3 class="text-dark border border-dark rounded p-3" >Agregar artículo</h3>
                    <form action="ArticuloControl" method="post" >
                        <br>
                        <p>Código : </p>
                        <input class="form-control mr-sm-2" type="text" name="cod" value="" >
                        <p>Nombre : </p>
                        <input class="form-control mr-sm-2" type="text" name="nom" value="" >
                        <p>Precio : </p>
                        <input class="form-control mr-sm-2" type="text" name="pre" value="" >
                        <p>Cantidad disponible : </p>
                        <input class="form-control mr-sm-2" type="text" name="sto" value="" >
                        <br>
                        <input class="btn btn-outline-success btn-lg btn-block" type="submit" name="acc" value="Grabar" >
