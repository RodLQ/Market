<%-- 
    ...
    Created on : 16-may-2021, 19:44:11
    Author     : PC
--%>
            ...
            <div class="row text-center">
                ...
                <div class="col-12 col-xl-6 border rounded p-5" >
                    ...
                    <form action="ArticuloControl" method="post" >
                        ...
                        <p>Precio : </p>
                        <input class="form-control mr-sm-2" type="text" name="pre" value="<%= f[2] %>" >
                        <p>Cantidad disponible : </p>
                        <input class="form-control mr-sm-2" type="text" name="sto" value="<%= f[3] %>" >
                        <br>
