<%-- 
    ...
    Created on : 04-may-2021, 19:32:37
    Author     : PC
--%>
        ...
        <div class="ordenar-footer-all container" >           
            ...
            <div class="row text-center">
                ...
                <div class="col-12 col-xl-6 border rounded p-5" >
                    <h3 class="text-dark border border-dark rounded p-3" >Buscar Empleado</h3>
                    <form action="EmpleadoControl" method="post" >
                        <br>
                        <p>Código : </p>
                        <input class="form-control mr-sm-2" type="text" name="cod" >
                        <br>
                        <input class="btn btn-outline-success btn-lg btn-block" type="submit" name="acc" value="Buscar" >
