<%-- 
    ...
    Created on : 04-may-2021, 19:45:11
    Author     : PC
--%>
        ...
        <div class="ordenar-footer-all container" >           
            ...
            <div class="row text-center">
                ...
                <div class="col-12 col-xl-6 border rounded p-5" >
                    <h3 class="text-dark border border-dark rounded p-3" >Editar Empleado</h3>
                    ...
                    <form action="EmpleadoControl" method="post" >
                        ...
                        <p>Tipo : </p>
                        <input class="form-control mr-sm-2" type="text" name="tip" value="<%= f[2] %>" >
                        <br>
