<%-- 
    ...
    Created on : 16-abr-2021, 13:45:09
    Author     : PC
--%>
                    ...
                    <div class="col-10">
                        <div class="row">
                            <div class="col-12 col-xl-6 border rounded bordesombra" >
                                <form  class="p-4" action="ProveedorControl" method="post">
                                    <h4 class="text-secondary" >Registrar Proveedor</h4>
                                    <div class="m-3 text-secondary" >
                                        <div class="row"><h5>Código :</h5></div>
                                        <div class="row"><div class="col-12"><input class="btn-lg border-success col-12" type="text" name="codPro"></div></div>
                            ...
                            <div class="col-12 col-xl-6 border rounded borrarimagen bordesombra" >
                                <div class="row" >
                                    <img src="img/proveedor.jpg" class="img-fluid rounded" >
                                </div>
                            </div>
                        </div>
                    </div>
